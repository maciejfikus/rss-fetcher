...
final class CSVSimpleCommand extends Command
{
    ...
    {
        $this
            ->setDescription('Pobranie z URL danych RSS/Atom i zapisanie ich do pliku PATH.csv określonego przez argument PATH ')
